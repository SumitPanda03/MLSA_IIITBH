        ...
        <div className="custom-content">
          ...
          <ol>
            <li>
              ...
              <strong style={{ color: "#f2cc8f" }}>16</strong> years old, have
          ...
          <p>
            ...
            <strong style={{ color: "#f2cc8f" }}>quarterly basis</strong>
            . <br />
          ...
          <ol>
            <li>
              ...
              . Click on "
              <strong style={{ color: "#f2cc8f" }}>Apply now</strong>" and{" "}
              <strong style={{ color: "#f2cc8f" }}>Login</strong> with any of
              the mentioned options available.
            </li>
            <br />
            <li>
              Once you are logged in, read all the{" "}
              <strong style={{ color: "#f2cc8f" }}>privacy and terms</strong>,
            ...
            <li>
              ...
              <strong style={{ color: "#f2cc8f" }}>Written Sample</strong>.
            </li>
            <br />
            <li>
              ...
              <ul>
                <li>
                  <strong style={{ color: "#f2cc8f" }}>Guide</strong>
                </li>
                <li>
                  <strong style={{ color: "#f2cc8f" }}>Connect</strong>
                </li>
                <li>
                  <strong style={{ color: "#f2cc8f" }}>Welcome</strong>
                </li>
              </ul>
              <br />
              <p>
                Two of the above mentioned are needed to be{" "}
                <strong style={{ color: "#f2cc8f" }}>essay type</strong>{" "}
                descriptive answer under{" "}
                <strong style={{ color: "#f2cc8f" }}>2000 characters</strong>{" "}
                and one of them must be a video with duration atmost{" "}
                <strong style={{ color: "#f2cc8f" }}>2 minutes</strong>
                .
                <br />
                <br />
                <strong style={{ color: "#f2cc8f" }}>
            ...
            <li>
              Then comes the{" "}
              <strong style={{ color: "#f2cc8f" }}>social media</strong>{" "}
            ...
            <li>
              ...
              all the <strong style={{ color: "#f2cc8f" }}>technologies</strong>{" "}
